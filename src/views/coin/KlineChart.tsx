...
import { Select, SelectItem, Spinner, Slider } from '@nextui-org/react';
import {
    Chart as ChartJS,
    CategoryScale,
    LinearScale,
        ...
        return {
            ...
            datasets: [
                ...
                },
                {
                    ...
                    type: 'bar' as const,
                    backgroundColor: visibleData.map((k) =>
                        k.close >= k.open
                            ? 'rgba(34, 197, 94, 0.8)'
                            : 'rgba(239, 68, 68, 0.8)',
                    ),
                    borderColor: visibleData.map((k) =>
                        k.close >= k.open
                            ? 'rgb(34, 197, 94)'
                            : 'rgb(239, 68, 68)',
                    ),
        ...
        plugins: {
            legend: {
                ...
                labels: {
                    ...
                    filter: (item: any) =>
                        !['Candle Body', 'Wick'].includes(item.text),
                },
            },
            tooltip: {
                mode: 'index' as const,
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                    ...
                    >
                        ...
                        <SelectItem key="5m" value="5m">
                            5 minutes
                        </SelectItem>
                        <SelectItem key="15m" value="15m">
                            15 minutes
                        </SelectItem>
                        <SelectItem key="1h" value="1h">
                            1 hour
                        </SelectItem>
                        <SelectItem key="4h" value="4h">
                            4 hours
                        </SelectItem>
                        <SelectItem key="1d" value="1d">
                            1 day
                        </SelectItem>
                    </Select>
                </div>
                ...
                <div className="px-6 py-4 bg-slate-50 rounded-xl border border-slate-100">
                    <Slider
                        ...
                        onChange={(v: number | number[]) =>
                            setViewRange(v as [number, number])
                        }
                        classNames={{
                        ...
                        renderValue={(props) => (
                            <div
                                {...(props as any)}
                                className="flex gap-4 text-[10px] font-bold text-blue-600"
                            >
                                <span>
                                    {moment(
                                        data.kline_data[
