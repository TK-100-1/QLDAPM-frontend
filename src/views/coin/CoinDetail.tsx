...
const renderVipRole = (rank: number) => {
  return (
    <Chip
      radius="sm"
      className="bg-slate-100 text-slate-500 font-bold border-none"
    >
      #{rank}
    </Chip>
  );
    ...
    <div className="flex flex-col lg:flex-row w-full gap-12 pt-8">
      ...
      <div className="flex-1 flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-6 mt-4">
            ...
            <div className="flex items-center gap-4">
              ...
              {coinDetail.market_data.price_change_percentage_24h != null && (
                <div
                  className={`flex items-center px-3 py-1.5 rounded-full font-bold text-lg ${
        ...
        >
          ...
          <Tab key="kline" title="Kline Chart">
            <div className="py-8">
              <VIPUpgradeGuard
                allowedRoles={["VIP-1", "VIP-2", "VIP-3", "Admin"]}
              >
